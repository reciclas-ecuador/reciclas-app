  ...
  return (
    <tab.Navigator
      ...
      screenOptions={({ route }) => ({
        ...
        tabBarStyle: { backgroundColor: '#494D4F', borderColor: '#494D4F', height: 50 },
    ...
    >
      ...
      <Stack.Screen name='DetailsNews' component={DetailsNews} options={{ tabBarButton: () => null, tabBarVisible: false }} />
